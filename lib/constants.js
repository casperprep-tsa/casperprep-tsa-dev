...
export const PLANS = {
  ...
  question_bank: {
    ...
    desc: "Practice questions, answer keys & progress tracking",
    price: 99,
    modules: [6, 7],
    features: [
      "4 practice sets, 40+ questions",
...
export const MODULES = [
  ...
  },
  {
    ...
    desc: "4 practice sets with 40+ questions and detailed expert answer keys using all 6 frameworks.",
    items: ["40+ practice questions", "Expert answer keys with frameworks", "Progressive difficulty sets"],
    lessons: 10,
  },
  {
    num: 7,
...
export const CHECKOUT_MODULES = [
  ...
  { title: "Module 6: Comprehensive Question Bank", desc: "4 practice sets with 40+ questions & expert answer keys" },
